(function exposeChains(global) {
  ...
  const vizApps = [
    ...
    { id: 'witnesses-rewards', title: 'Награды делегатов', description: 'Список делегатов VIZ через публичный RPC и документация legacy reward-колонок за текущий/предыдущий день и месяц без старого backend.', accountField: false },
    { id: 'randomblockchain', title: 'Случайный блокчейн', description: 'Детерминированный random по witness_signature двух публичных блоков VIZ.' },
    { id: 'top', title: 'Топ пользователей', description: 'VIZ рейтинги: legacy категории сохранены, серверные 100-row leaderboard-таблицы отмечены как backend-only.', accountField: false },
  ...
  const golosApps = [
    ...
    { id: 'top', title: 'Топ пользователей', description: 'Рейтинги Golos: сохранён список категорий и UIA-токенов через публичный RPC; серверные leaderboard-таблицы не восстанавливаются.', accountField: false },
    { id: 'witnesses-rewards', title: 'Награды делегатов', description: 'Список делегатов Golos через публичный RPC и документация legacy reward-колонок за текущий/предыдущий день и месяц без старого backend.', accountField: false },
