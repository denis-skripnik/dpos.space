...
<p>В поле "публичный ключ делегата" впишите ваш ключ делегата, который генерировали при запуске Ноды. Он должен начинаться с VIZ. Если хотите отключить делегата, оставьте поле пустым.</p>
<form>
...
<p><label for="witness_key">Публичный ключ делегата: 
    <input type="text" name="witness_key" value="" placeholder="VIZ..."></label></p>
...
<script src="'.$conf['siteUrl'].'blockchains/viz/apps/manage/pages/witness/footer.js"></script>
'; ?>