...
$chf['posts_window'] = "Длительность интервала/окна для постов (секунды)";
$chf['posts_per_window'] = "Кол-во постов за интервал";
$chf['comments_window'] = "Длительность интервала/окна для комментариев (секунды)";
$chf['comments_per_window'] = "Кол-во комментариев за интервал";
$chf['votes_window'] = "Длительность интервала/окна для голосования (секунды)";
