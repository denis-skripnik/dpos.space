...
function proxyVote(field_name) {
    ...
    steem.broadcast.accountWitnessProxy(active_key, steem_login, proxy_login, function(err, result) {
if (!err) {
...
function oneWitnessVote() {
    ...
    steem.broadcast.accountWitnessVote(active_key, steem_login, witness_login, true, function(err, result) {
if (!err) {
