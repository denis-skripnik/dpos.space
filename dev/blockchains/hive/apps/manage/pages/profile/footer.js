if(0<$('.profile-update').length){
    hive.api.getAccounts([hive_login],function(err,response){
        if(!err){
...
var memo = response[0].memo_key;
            hive.broadcast.accountUpdate(active_key, hive_login, undefined, undefined, undefined, memo, json_metadata, function(err, result){
                if(!err){
