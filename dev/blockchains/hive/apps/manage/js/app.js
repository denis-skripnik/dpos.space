...
function proxyVote(field_name) {
    ...
    hive.broadcast.accountWitnessProxy(active_key, hive_login, proxy_login, function(err, result) {
if (!err) {
...
function oneWitnessVote() {
    ...
    hive.broadcast.accountWitnessVote(active_key, hive_login, witness_login, true, function(err, result) {
if (!err) {
