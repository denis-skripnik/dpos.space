...
<p><a href="'.$conf['siteUrl'].'viz/projects/news/?project_creator='.$_GET['project_creator'].'&project_name='.$_GET['project_name'].'" target="_blank">к списку</a>, <a href="'.$conf['siteUrl'].'viz/projects/one-news/?project_creator='.$_GET['project_creator'].'&project_name='.$_GET['project_name'].'&user='.$_GET['user'].'&date='.$_GET['date'].'" target="_blank">к чтению</a></p>
<ul><li>'.$el['date'].'</li>
<li>Автор: <a href="'.$conf['siteUrl'].'viz/profiles/'.$el['user'].'" target="_blank"><span id="news_login">'.$el['user'].'</span></a></li>
</ul>
';
