...
$filter = '{}';
	if (isset($_GET)) {
		$filter = '{project_creator: "'.$_GET['project_creator'].'", project_name: "'.$_GET['project_name'].'"}';
	}
$pagenum = 1;
$url = pageUrl();
...
$html = file_get_contents('http://138.201.91.11:3100/viz-api?service=viz-projects&type=news&filter='.$filter.'&page='.$pagenum);
