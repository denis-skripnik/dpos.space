...
<div class="form-group1">
	<label for="newAccountKey">Ключ (Будет и owner, и regular, и активным ключом аккаунта):<span style="color: red;">*</span> </label>
<input type="button" value="Генерировать" onclick="new_private_gen();">
	<input type="text" class="form-control required" id="new_account_key" name="newAccountKey" readonly required="required">
<input type="button" id="new_private_copy" value="Скопировать в буфер обмена"
</div>	
<div class="form-group1">
<hr>
<p><strong>ВНИМАНИЕ: запишите сгенерированный ключ в нескольких местах - его нельзя будет восстановить, если потеряете!</strong></p>
<hr>
</div>
...
<script src="'.$conf['siteUrl'].'blockchains/viz/apps/accounts/pages/registration/footer.js"></script>
'; ?>