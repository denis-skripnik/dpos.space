...
<div class="page page-manage-access" data-title="Доступы аккаунта">
	...
	manage_access_save(account,master_key,$(`.page-manage-access`));">
					...
					<div class="addon captions"><h3>Подсказка</h3><p>Если вы хотите просто сбросить ключи доступа для аккаунта — перейдите в подраздел <a data-href="/viz/manage/reset-keys">«Сбросить ключи»</a>.</p></div>
				</div>
			</div>
