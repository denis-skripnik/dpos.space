...
$html = file_get_contents('http://178.20.43.121:3000/golos-api?service=votes&type=voteing&permlink='.pageUrl()[3]);
if (pageUrl()[3] && $html) {
...
if ($answers && $table['end_date'] > time()) {
    ...
    <p><strong>Если вы авторизовались с указанием логина и постинг ключа (кнопка "Выбрать аккаунт" -> "Добавить"), сможете проголосовать, не выходя с этого сайта.</strong></p>
    <form class="form">
