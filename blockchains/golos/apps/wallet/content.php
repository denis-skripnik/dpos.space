...
<div style="display: none;" id="vesting_withdraw_modal">
                                                ...
                                                <p><input type="text" name="golos_transfer_amount" id="action_golos_transfer_amount" placeholder="1.000"></p>
...
<option value="to_vesting">в СГ</option>
                                                ...
                                                <p><input type="text" name="golos_gbg_transfer_amount" id="action_golos_gbg_transfer_amount" placeholder="1.000"></p>
                                                ...
                                                <p><input type="text" name="accumulative_balance_amount" id="accumulative_balance_amount" placeholder="1.000"></p>
...
<input type="checkbox" name="accumulative_balance_vesting" id="accumulative_balance_vesting" placeholder="Перевод в СГ"></label></p>
                                                ...
                                                <p><input type="text" name="donate_amount" id="donate_amount" placeholder="1.000"></p>
                                                ...
                                                <p><input type="text" name="transfer_from_tip_amount" id="transfer_from_tip_amount" placeholder="1.000"></p>
                                          ...
                                          <li><label><input type="checkbox" name="ops" value="transfer_to_vesting" placeholder="Переводы в СГ">Переводы в СГ</label></li>
