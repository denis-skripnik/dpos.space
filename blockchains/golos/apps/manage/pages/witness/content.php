...
<p>В поле "публичный ключ делегата" впишите ваш ключ делегата, который генерировали при запуске Ноды. Он должен начинаться с GOLOS. Если хотите отключить делегата, оставьте поле пустым.</p>
<form>
...
<p><label for="witness_key">Публичный ключ делегата: 
    <input type="text" name="witness_key" value="" placeholder="GLS..."></label></p>
...
<script src="'.$conf['siteUrl'].'/blockchains/golos/apps/manage/pages/witness/footer.js"></script>
'; ?>