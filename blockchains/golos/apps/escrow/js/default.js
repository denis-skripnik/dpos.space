// defaul language to work on local machine (without json)
var LNG = {
    "name":"English",
    "symbol":"en-EN",
    "words": {
        ...
        "enterId":"Enter transaction ID, for example xtar-8724723-steem:"
    },
    "byElement":{
        "title":"Send {steem_ticker}/{sbd_ticker} with escrow"
    },
    "byId": {
        "currentLanguage":"English",
        "currentBlockchain":"{steem_ticker}",
        ...
        "tabSend":"Send {steem_ticker}/{sbd_ticker}",
        "tabCP":"Control Panel",
        "tabBoard":"Board",
        ...
        "labelAgent":"Choose the escrow agent. To become an agent, post a comment <a href=\"https://golos.id/nsfw/@denis-skripnik/ru-khocheshx-statx-garantom-budx-im\">here</a> (sorted by agent reputation).",
        "selectOptionChooseAgent":"Choose an agent from the list",
        "labelSendFeeAmout":"Fee by",
        "inputSendAmount":"Amount, click to toggle {steem_ticker}/{sbd_ticker}",
