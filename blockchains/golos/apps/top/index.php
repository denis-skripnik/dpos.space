...
function generateAppPages() {
    ...
    $tokens = ['golos' => 'GOLOS', 'gbg' => 'GBG', 'gp' => 'СГ', 'delegated_gp' => 'делегированной другим СГ', 'received_gp' => 'полученной делегированием СГ', 'effective_gp' => 'эффективной СГ', 'tip_balance' => 'TIP-баланса', 'reputation' => 'репутации'];
