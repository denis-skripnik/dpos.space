...
return '<h2>Рассчитываем стоимость апвоута в зависимости от введённой СГ</h2>
...
<p><label name="vote_weight">Процент апвоута (от 1 до 100, устанавливается под постом, если Силы Голоса достаточно для этого): </label>
<input type="text" name="vote_weight" id="vote_weight" value=""> %</p>
<p align="center"><input type="button" id="result_power" value="Вывести стоимость апвоута"></p>
