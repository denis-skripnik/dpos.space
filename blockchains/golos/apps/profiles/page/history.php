...
<p><b>Загружается за раз 1000 элементов истории, а затем фильтруется по операциям и запросу. Поэтому если нет прибавки, кликайте ещё раз по ссылке "Ещё".<br>
Глубина истории <span id="history_level">0</span> элементов.</b></p>
<table class="two_columns"><thead><tr>
<th>Дата</th>
