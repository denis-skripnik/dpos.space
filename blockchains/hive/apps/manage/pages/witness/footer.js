...
$('#witness_options').click(function() {
    hive.api.getWitnessByAccount(hive_login, function(error, res) {
...
props.hbd_interest_rate = res.props.hbd_interest_rate;
    ...
    let fee = "0.000 HIVE";
    hive.broadcast.witnessUpdate(active_key, hive_login, url, blockSigningKey, props, fee, function(err, result) {
if (!err) {
...
if (prop.indexOf('rate') > -1) {
    prop_value *= 100;
        ...
        prop_value = prop_value.toFixed(3) + ' HIVE';
    }
