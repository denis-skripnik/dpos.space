...
$newStartPermlink = $start_permlink;
                break;
                  ...
                  $result['content'] .= '<tr>
                  <td>'.$created.'</td>
                  <td><a href="https://hive.blog/' . $content['parent_permlink'] . '/@' . $content['author'] . '/' . $content['permlink'] . '" target="_blank">' . $content['title'] . '</a></td>
<td><a href="'.$site_url.'hive/profiles/' . $content['author'] . '" target="_blank">' . $content['author'] . '</a></td>
<td>';
