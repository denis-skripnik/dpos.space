...
while ($startWith !== -1 && $rowCount !== TRX_LIMIT) {
    ...
    foreach ($mass as $datas) {
        ...
        $rowCount++;
        $name = 'Hiveование по заявке воркера';
...
$result['content'] .= '<tr>
<td>'.$timestamp.'</td>
<td><a href="'.$site_url.'hive/profiles/'.$voter.'" target="_blank">'.$voter.'</a></td>
<td>Заявка <a href="'.$site_url.'hive/manage/workers#'.$author.'/'.$permlink.'" target="_blank">'.$author.'/'.$permlink.'</a></td>
...
$result['content'] .= '<tr>
<td>'.$timestamp.'</td>
<td><a href="'.$site_url.'hive/profiles/'.$account.'" target="_blank">'.$account.'</a></td>
<td><a href="'.$site_url.'hive/profiles/'.$witness.'" target="_blank">'.$witness.'</a></td>
<td>'.$name.' '.$approve.'</td>
</tr>';
                if ($rowCount === TRX_LIMIT) {
            break;
...
<td>'.$timestamp.'</td>
<td><a href="'.$site_url.'hive/profiles/'.$account.'" target="_blank">'.$account.'</a></td>
<td><a href="'.$site_url.'hive/profiles/'.$proxy.'" target="_blank">'.$proxy.'</a></td>
<td>'.$name.'</td>        
</tr>';
                if ($rowCount === TRX_LIMIT) {
            break;
...
$result['content'] .= '<tr>
<td>'.$timestamp.'</td>
<td><a href="'.$site_url.'hive/profiles/'.$author.'" target="_blank">'.$author.'</a></td>
<td><a href="'.$site_url.'hive/profiles/'.$worker.'" target="_blank">'.$worker.'</a></td>
<td>'.$name.'. '.$amounts.', в Hive Power: '.$vest_reward.' <a href="https://hive.blog/@'.$author.'/'.$permlink.'" target="_blank">Пост</a></td>
</tr>';
                if ($rowCount === TRX_LIMIT) {
            break;
        }
