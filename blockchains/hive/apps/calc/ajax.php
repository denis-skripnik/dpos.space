...
// Конвертация HIVE POWERв VESTS
// $sp - поле со введённым значением СГ.
$vesting_shares = $sp * 1000000 / $hive_per_vests;
...
echo "<p>Стоимость апвота: $dasdas_golos HIVE, $dasdas_gbg HBD</p>";
   ...
   $sp_result = round($sptec / 1000000 * $hive_per_vests, 3);
   
   echo "<p>Результат конвертации: $sp_result HP</p>";
}
?>