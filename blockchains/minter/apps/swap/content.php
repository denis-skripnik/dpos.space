...
<p><label for="pool_amount1">Сумма в <span class="convert_modal_token"></span> (<span id="max_token_pool1">Максимум - <span id="max_pool_amount1"></span></span>):</label></p>
...
<p><label for="tokens2">Токен №2:
      ...
      <p><label for="pool_amount2">Сумма в <span class="convert_modal_token"></span> (<span id="max_token_pool2">Максимум - <span id="max_pool_amount2"></span></span>):</label></p>
      <p><input type="text" name="pool_amount2" id="action_pool_amount2" required placeholder="Введите сумму в формате 1.000"></p>
<p><strong>Комиссия: <span id="convert_fee">1</span> <span class="convert_modal_token"></span></strong></p>
