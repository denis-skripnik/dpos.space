...
return '<div id="auth_msg" style="display: none;"><p>Для работы с Minter swap необходимо авторизоваться seed фразой. Добавить аккаунт можно нажав кнопку "Выбрать аккаунт" в верхней части страницы, затем "Добавить".</p></div>
<div id="seed_page">
<div class="tab">
