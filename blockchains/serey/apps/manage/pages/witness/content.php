...
<th><a href="'.$conf['siteUrl'].'serey/manage/witnesses">Делегаты</a></th>
<th><a href="'.$conf['siteUrl'].'serey/manage/profile">Профиль</a></th>
</tr></table>
<div id="auth_msg" style="display: none;"><p>Вы не авторизовались. Просьба сделать это <a href="'.$conf['siteUrl'].'serey/accounts" target="_blank">здесь</a></p></div>
...
<p>В поле "публичный ключ делегата" впишите ваш ключ делегата, который генерировали при запуске Ноды. Он должен начинаться с SEREY. Если хотите отключить делегата, оставьте поле пустым.</p>
<form class="form">
...
<script src="'.$conf['siteUrl'].'/blockchains/serey/apps/manage/pages/witness/footer.js"></script>
'; ?>