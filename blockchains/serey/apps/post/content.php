 ...
 <table border="1" cellpadding="5" width="100%"><thead>
    <tr>
     <th colspan="3">Теги</th>
         ...
         <tr>
         <td><button type="button" class="popular_tags" id="tag9" value="hive"></button></td>
...
<option selected="selected" value="10000">50% в HBD и SEREY, 50% в SP</option>
<option value="0">100% в SP</option>
</select></p>
<hr>
    <div class="spoy_load">
...
<script src="'.$conf['siteUrl'].'blockchains/serey/apps/post/js/_interface.js"></script>
'; ?>