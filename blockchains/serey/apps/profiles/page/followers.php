...
foreach ($mass4 as $datas4) {
    $result['content'] .= '<li><a href="'.$siteUrl.'serey/profiles/'.$datas4['follower'].'" target="_blank">'.$datas4['follower'].'</a></li>';
}
$result['content'] .= '</ol>';    
} else {
...
<ol>';
foreach ($mass4 as $datas4) {
            $result['content'] .= '<li><a href="'.$siteUrl.'serey/profiles/'.$datas4['following'].'" target="_blank">'.$datas4['following'].'</a></li>';
        }
$result['content'] .= '</ol>';
    }
} else {
