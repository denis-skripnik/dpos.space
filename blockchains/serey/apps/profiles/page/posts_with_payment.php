...
foreach ($posts as $post) {
    ...
    if ($post['author'] == $user) {
        ...
        $result['content'] .= '<td><a href="https://serey.io/authors/'.$post['author'] . '/'.$post['permlink'].'" target="_blank">' . $post['title'] . '</a> (Репост от <a href="'.$site_url.'serey/profiles/' . $post['author'] . '" target="_blank">@' . $post['author'] . '</a>)</td>';
    }
