...
$data['content'] .= require_once(__DIR__.'/page/userinfo.php');
    ...
    getLoad(`'.$conf['siteUrl'].'blockchains/serey/apps/profiles/page/transfers.php`, `transfers_content`, `Следующие 10`, `Предыдущие 10`)(START_MODE)
    </script>';
$data['content'] .= $blockchain_snippet;
    $data['content'] .= $pages;
...
$data['content'] .= require_once(__DIR__.'/page/sp.php');
    ...
    ajax_options.user = `'.$user.'`;
    ajax_options.siteUrl = `'.$conf['siteUrl'].'`;
    getLoad(`'.$conf['siteUrl'].'blockchains/serey/apps/profiles/page/author_rewards.php`, `ajax_content`, `Следующие 5`, `Предыдущие 5`)(START_MODE)
    </script>';
    $data['content'] .= $blockchain_snippet;
    $data['content'] .= $pages;
$data['content'] .= require_once(__DIR__.'/page/author_rewards.php');
    ...
    ajax_options.user = `'.$user.'`;
    ajax_options.siteUrl = `'.$conf['siteUrl'].'`;
    getLoad(`'.$conf['siteUrl'].'blockchains/serey/apps/profiles/page/curation_rewards.php`, `ajax_content`, `Следующие 5`, `Предыдущие 5`)(START_MODE)
    </script>';
    $data['content'] .= $blockchain_snippet;
    $data['content'] .= $pages;
$data['content'] .= require_once(__DIR__.'/page/curation_rewards.php');
    ...
    ajax_options.user = `'.$user.'`;
    ajax_options.siteUrl = `'.$conf['siteUrl'].'`;
    getLoad(`'.$conf['siteUrl'].'blockchains/serey/apps/profiles/page/benefactor_rewards.php`, `ajax_content`, `Следующие 5`, `Предыдущие 5`)(START_MODE)
    </script>';
    $data['content'] .= $blockchain_snippet;
    $data['content'] .= $pages;
$data['content'] .= require_once(__DIR__.'/page/benefactor_rewards.php');
    ...
    ajax_options.user = `'.$user.'`;
    ajax_options.siteUrl = `'.$conf['siteUrl'].'`;
    getLoad(`'.$conf['siteUrl'].'blockchains/serey/apps/profiles/page/dao.php`, `transfers_content`, `Следующие 10`, `Предыдущие 10`)(START_MODE)
    </script>';
    $data['content'] .= $blockchain_snippet;
    $data['content'] .= $pages;
$data['content'] .= require_once(__DIR__.'/page/dao.php');
    ...
    ajax_options.user = `'.$user.'`;
    ajax_options.siteUrl = `'.$conf['siteUrl'].'`;
    getLoad(`'.$conf['siteUrl'].'blockchains/serey/apps/profiles/page/accounts.php`, `transfers_content`, `Следующие 10`, `Предыдущие 10`)(START_MODE)
    </script>';
    $data['content'] .= $blockchain_snippet;
    $data['content'] .= $pages;
...
$data['content'] .= require_once(__DIR__.'/page/blog-posts.php');
    ...
    ajax_options.user = `'.$user.'`;
    ajax_options.siteUrl = `'.$conf['siteUrl'].'`;
    getLoad(`'.$conf['siteUrl'].'blockchains/serey/apps/profiles/page/posts_with_payment.php`, `ajax_content`, `Следующие 20`, `Предыдущие 20`)(START_MODE)
    </script>';
    $data['content'] .= $blockchain_snippet;
    $data['content'] .= $pages;
$data['content'] .= require_once(__DIR__.'/page/posts_with_payment.php');
    ...
    ajax_options.user = `'.$user.'`;
    ajax_options.siteUrl = `'.$conf['siteUrl'].'`;
    getLoad(`'.$conf['siteUrl'].'blockchains/serey/apps/profiles/page/comments.php`, `ajax_content`, `Следующие 20`, `Предыдущие 20`)(START_MODE)
    </script>';
    $data['content'] .= $blockchain_snippet;
    $data['content'] .= $pages;
$data['content'] .= require_once(__DIR__.'/page/comments.php');
    ...
    ajax_options.user = `'.$user.'`;
    ajax_options.siteUrl = `'.$conf['siteUrl'].'`;
    getLoad(`'.$conf['siteUrl'].'blockchains/serey/apps/profiles/page/feed.php`, `ajax_content`, `Следующие 50`, `Предыдущие 50`)(START_MODE)
    </script>';
    $data['content'] .= $blockchain_snippet;
    $data['content'] .= $pages;
