...
<ul id="steem_actions" class="terms walletSpoiler" style="display: none;"><li><a data-fancybox data-src="#steem_transfer_modal" href="javascript:;">Перевести steem</a></li>
<li><a data-fancybox data-src="#to_shares_transfer_modal" href="javascript:;">steem в SP этого аккаунта</a></li>
<li><a href="'.$conf['siteUrl'].'steem/swap">Обменять STEEM</a></li></ul>
                                                <ul id="sbd_actions" class="terms walletSpoiler" style="display: none;"><li><a data-fancybox data-src="#steem_sbd_transfer_modal" href="javascript:;">Перевести SBD</a></li>
<li><a href="'.$conf['siteUrl'].'steem/swap/SBD">Обменять SBD</a></li></ul>
<ul id="sp_actions" class="terms walletSpoiler" style="display: none;"><li><a data-fancybox data-src="#vesting_withdraw_modal" href="javascript:;">Вывод SP в steem</a></li>
