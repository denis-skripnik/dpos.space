...
var full_vesting_withdraw = (vesting_withdraw_rate*4).toFixed(6) + ' SP';
...
function prepareContent(text) {
  ...
  }).replace(/ (@[^< \.,]+)/gi, user => ` <a href="/steem/profiles/${user.trim().slice(1)}">${user.trim()}</a>`)
 }
...
<td><a href="/steem/profiles/' + from + '" target="_blank">@' + from + '</a></td>\
<td><a href="/steem/profiles/' + to + '" target="_blank">@' + to + '</a></td>\
<td>' + amount + '</td>\
<td>' + memo + '</td>\
</tr>');
...
<td><a href="/steem/profiles/' + author + '" target="_blank">@' + author + '</a></td>\
<td><a href="/steem/profiles/' + curator + '" target="_blank">@' + curator + '</a></td>\
<td>' + reward + '</td>\
<td>' + memo + '</td>\
</tr>');
...
<td><a href="/steem/profiles/' + author + '" target="_blank">@' + author + '</a></td>\
<td><a href="/steem/profiles/' + benefactor + '" target="_blank">@' + benefactor + '</a></td>\
<td>' + sbd_payout + ', ' + steem_payout + ' и ' + vesting_payout + '</td>\
<td>' + memo + '</td>\
</tr>');
...
<td>' + from + '</td>\
<td><a href="/steem/profiles/' + witness + '" target="_blank">@' + witness + '</a></td>\
<td>' + shares + '</td>\
<td>' + memo + '</td>\
</tr>');
  }
