...
<input type="checkbox" id="spoiler_links3"><label for="spoiler_links3">Редактировать пост (введите ссылку)</label>
 <div class="spoiler_body">
<input type="text" id="postediturl" name="postedit" placeholder="https://steemit.com/tag/@user/permlink">
 ...
 <table border="1" cellpadding="5" width="100%"><thead>
    <tr>
     <th colspan="3">Теги</th>
         ...
         <tr>
         <td><button type="button" class="popular_tags" id="tag9" value="steem">Steem</button></td>
...
<option selected="selected" value="10000">50% в SBD и STEEM, 50% в SP</option>
...
<script src="'.$conf['siteUrl'].'blockchains/steem/apps/post/js/_interface.js"></script>
'; ?>