...
while ($startWith !== -1 && $rowCount !== AUTHOR_REWARDS_LIMIT) {
    ...
    krsort($mass);
            ...
            $result['content'] = '<div id="ajax_content"><h2>Кураторские награды пользователя '.$user.'</h2>
    <table id="rewards-ol">
