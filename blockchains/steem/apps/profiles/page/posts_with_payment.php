...
foreach ($posts as $post) {
    ...
    if ($post['author'] == $user) {
        ...
        $result['content'] .= '<td><a href="https://steemit.com/'.$post['url'] . '" target="_blank">' . $post['title'] . '</a> (Репост от <a href="'.$site_url.'steem/profiles/' . $post['author'] . '" target="_blank">@' . $post['author'] . '</a>)</td>';
    }
