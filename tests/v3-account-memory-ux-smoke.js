...
assert(appSource.includes("`${chain.id}_recent_accounts`"), 'recent viewed account storage key stays separate from legacy authorized users and shared across network mode');
