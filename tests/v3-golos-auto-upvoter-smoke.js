...
assert(indexSource.includes('v3/js/auto-upvoter.js') && indexSource.indexOf('v3/js/auto-upvoter.js') < indexSource.indexOf('v3/js/app.unified-services.js'), 'Auto-upvoter helper is loaded by index before app runtime');
