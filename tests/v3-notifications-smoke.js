...
assert(indexSource.includes('v3/js/notifications.js') && indexSource.indexOf('v3/js/notifications.js') < indexSource.indexOf('v3/js/app.unified-native-worker.js'), 'notifications module loads before app runtime');
