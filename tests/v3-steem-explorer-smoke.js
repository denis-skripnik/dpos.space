...
const legacyConfig = readLegacyFile('blockchains/steem/apps/explorer/config.json');
const legacyContent = readLegacyFile('blockchains/steem/apps/explorer/content.php');
const legacyIndex = readLegacyFile('blockchains/steem/apps/explorer/index.php');
const legacyBlock = readLegacyFile('blockchains/steem/apps/explorer/pages/block/content.php');
const legacyBlockRpc = readLegacyFile('blockchains/steem/apps/explorer/pages/block/block.php');
const legacyTx = readLegacyFile('blockchains/steem/apps/explorer/pages/tx/content.php');
const legacyTxRpc = readLegacyFile('blockchains/steem/apps/explorer/pages/tx/get_transaction.php');
