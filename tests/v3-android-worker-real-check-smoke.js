...
assert(voteBroadcast.includes('verify_authority') && runner.includes('self-award submitting with bounded worker'), 'VIZ self-award verifies signed transaction authority with the node before broadcast');
