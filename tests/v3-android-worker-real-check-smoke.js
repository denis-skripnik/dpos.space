...
assert(voteBroadcast.includes('asyncBroadcastOnly = false') && voteBroadcast.includes('"broadcast_transaction"') && voteBroadcast.includes('"broadcast_transaction_synchronous"'), 'VIZ native self-award uses synchronous broadcast result first; async remains available only as a lower-level method name');
