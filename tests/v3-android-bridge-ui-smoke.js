...
assert(autoUpvoterSlice.includes('data-android-worker-panel'), 'auto-upvoter renders an Android background status panel');
assert(autoUpvoterSlice.includes('aria-live="polite"') && autoUpvoterSlice.includes('android-worker-status'), 'Android background status is TalkBack-friendly');
