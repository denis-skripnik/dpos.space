 ...
 */
const DPOS_CACHE_VERSION = 'dpos-space-v3-20260726-golos-worker-history';
const DPOS_SHELL_ASSETS = [
  '/',
  '/index.html',
  '/manifest.webmanifest',
  '/v3/css/style.css?v=20260726-golos-worker-history',
  '/v3/js/chains.js?v=20260726-golos-worker-history',
  '/v3/js/auth.js?v=20260726-golos-worker-history',
  '/v3/js/broadcast.js?v=20260726-golos-worker-history',
  '/v3/js/profiles.js?v=20260726-golos-worker-history',
  '/v3/js/history.js?v=20260726-golos-worker-history',
  '/v3/js/notifications.js?v=20260726-golos-worker-history',
  '/v3/js/auto-upvoter.js?v=20260726-golos-worker-history',
  '/v3/js/pwa.js?v=20260726-golos-worker-history',
