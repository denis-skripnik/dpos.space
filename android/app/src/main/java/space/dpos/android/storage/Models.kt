...
data class AutoUpvoterSettings(val chainId: String, val account: String, val enabled: Boolean, val minEnergy: Int, val maxActionsPerTick: Int = 5, val dryRunOnly: Boolean = true)
