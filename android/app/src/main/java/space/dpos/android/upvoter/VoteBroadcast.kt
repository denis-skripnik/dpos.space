...
object GrapheneChainSpecs {
    private val specs = mapOf(
        ...
        "viz" to GrapheneChainSpec("viz", VIZ_CHAIN_ID, DEFAULT_VIZ_RPC, rpcEndpoints = listOf(DEFAULT_VIZ_RPC, "https://node.viz.cx"), publicKeyPrefix = "VIZ", legacyCallRpc = true, historyApiName = "account_history", nativeVoteSupported = false, notificationOps = listOf("comment", "transfer", "award", "fixed_award", "receive_award", "benefactor_award"), asyncBroadcastOnly = false)
    )
