...
$nameArhive = $_SERVER['DOCUMENT_ROOT'].'/backup/archives/'.$chain.'_'.$_POST['WLS_login'].'.zip'; //название архива
...
echo '<p>Резервная копия успешно создана. Вы можете <a href="https://dpos.space/backup/archives/'.$chain.'_'.$_POST['WLS_login'].'.zip" target="_blank">скачать архив</a></p>
<p>Либо вы можете скопировать адрес из поля ниже:
<form><input type="url" name="download_url" value="https://dpos.space/backup/archives/'.$chain.'_'.$_POST['WLS_login'].'.zip"></form></p>';
} else {
