...
js.php - передача в ajax.php данных из формы.
...
- index.php - основной файл. Выводится подключение блоков, а также производится вывод сообщения, если блокчейн не выбран.
