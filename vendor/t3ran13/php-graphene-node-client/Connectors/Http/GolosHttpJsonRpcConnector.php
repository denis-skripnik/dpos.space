...
class GolosHttpJsonRpcConnector extends HttpJsonRpcConnectorAbstract
{
     ...
     * @var string
     */
    protected static $nodeURL = ['https://api-golos.blckchmd.com', 'https://api.aleksw.space', 'https://api-full.golos.id', 'https://apinode.golos.today', 'https://api.golos.blckchnd.com', 'https://golos.solox.world', 'https://golos.lexa.host'];
}