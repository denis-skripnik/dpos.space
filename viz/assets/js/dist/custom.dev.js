...
$(document).ready(function ($) {
  ...
  $("[data-bg-color], [data-bg-image], [data-bg-particles]").each(function () {
    ...
    if ($this.hasClass("ts-separate-bg-element")) {
      $this.append('<div class="ts-background">'); // Background Color
  ...
  if ($owlCarousel.length) {
    $owlCarousel.each(function () {
      ...
      if (!fadeOut) fadeOut = 0;else fadeOut = "fadeOut";
      if ($("body").hasClass("rtl")) var rtl = true;else rtl = false;
  ...
  $(".ts-count-down").each(function () {
    ...
    $(this).countdown({
      ...
      render: function render(data) {
        var el = $(this.el);
        el.empty().append("<div><span class='ts-cc-number'>" + this.leadingZeros(data.days, 2) + " </span><span class='ts-cc-description'>Days</span></div>").append("<div><span class='ts-cc-number'>" + this.leadingZeros(data.hours, 2) + " </span><span class='ts-cc-description'>Hours</span></div>").append("<div><span class='ts-cc-number'>" + this.leadingZeros(data.min, 2) + " </span><span class='ts-cc-description'>Minutes</span></div>").append("<div><span class='ts-cc-number'>" + this.leadingZeros(data.sec, 2) + " </span><span class='ts-cc-description'>Seconds</span></div>");
      }
    });
  }); // Magnific Popup
