...
<p class="footer_text">Создал данный клиент незрячий программист <a href="https://<?php echo ($client ?? $client ?? "golos.id"); ?>/@denis-skripnik" target="_blank"><span id="creator_login">denis-skripnik</span></a>.</p>
<p class="footer_text">Создатель сервиса также является делегатом на Голосе и VIZ. Просьба проголосовать за <strong>denis-skripnik</strong> тут: <a href="https://golos.id/~witnesses" target="_blank">https://golos.id/~witnesses</a> и тут: <a href="https://viz.world/witnesses/denis-skripnik/" target="_blank">https://viz.world/witnesses/denis-skripnik/</a></p>
<?php
...
<ul><li><a href="https://golos.id/@'.$_SESSION['user_name'].'/transfers" target="_blank">Golos</a></li>
